...
export default function AdminPage() {
  ...
  const handleBatchGenerate = async () => {
    ...
    // Vérifier si des sous-catégories sont sélectionnées
    ...
    const sectionsToGenerate: string[] = [...selectedSubcategories];
                ...
                <>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        <h3 className="text-lg font-medium text-blue-800">Sélection des sous-catégories</h3>
                      </div>
                      ...
                      <div className="border rounded-md p-4 space-y-2">
                        {SECTION_TYPES.map(type => (
                          <div key={type.id} className="space-y-1">
                            <div className="font-medium py-1 text-blue-700">{type.name}</div>
                  ...
                  <div className="flex justify-between mt-6">
                    ...
                    <Button 
                      ...
                      disabled={selectedConventions.length === 0 || selectedSubcategories.length === 0}
                    >
